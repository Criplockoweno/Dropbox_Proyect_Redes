...
class HTMLPreprocessing:
    ...
    def process_html(self):
        ...
        for filename in file_manager.get_files_on_directory():
            ...
            list_file_html = self.get_file_html(filename, size, path, date)
            file_list_container = soup.find('div', {'id': 'filesList'})
            file_list_container.append(BeautifulSoup(list_file_html, 'html.parser'))
        return soup.prettify(formatter="html")
    
    def get_file_html(self, file_name:str, size:str, path:str, submission_date:str):
        return f"""<div class="card my-2">
                    <div class="card-body d-flex justify-content-between align-items-center">
                        <p class="card-text my-0">{file_name}</p>
                        <a class="my-0" href="{'/Users/joche/OneDrive - Universidad San Francisco de Quito/Universidad/Octavo Semestre/Redes/Proyecto/Dropbox_Proyect_Redes/files/File.txt'}" download>
